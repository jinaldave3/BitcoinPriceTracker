...
// node_modules/use-debounced-effect/lib/index.js
var require_lib = __commonJS({
  "node_modules/use-debounced-effect/lib/index.js"(exports) {
    ...
    function useDebouncedEffect(callback, config) {
      ...
      var _currentConfig = currentConfig, timeout = _currentConfig.timeout, ignoreInitialCall = _currentConfig.ignoreInitialCall;
      var data = (0, _react.useRef)({ firstTime: true });
      (0, _react.useEffect)(function() {
        var _data$current = data.current, firstTime = _data$current.firstTime, clearFunc = _data$current.clearFunc;
...
//# sourceMappingURL=use-debounced-effect.js.map
